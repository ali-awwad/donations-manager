...
function Edit() {
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_5__.useEffect)(function () {
    campaigns.data.filter(function (campaign) {
      if (campaign.id === parseInt(values.campaign_id)) {
        setSelectedCampaign(campaign);
      }
    });
    donors.data.filter(function (donor) {
  ...
  function handleSubmit(e) {
    e.preventDefault();
    _inertiajs_inertia__WEBPACK_IMPORTED_MODULE_3__.Inertia.patch("/donations/".concat(item.data.id), values);
  }
