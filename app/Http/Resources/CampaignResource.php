...
class CampaignResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        return [
            ...
            'name' => $this->name,
            'slug' => $this->slug,
            'target' => __(config('services.currency')).' '.friendly_money($this->target),
            ...
            'collected' => __(config('services.currency')).' '.friendly_money(Donation::where('campaign_id', $this->id)->sum('amount')),
