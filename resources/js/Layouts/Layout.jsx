                            ...
                            <div className="relative flex-1 flex flex-col max-w-xs w-full bg-gray-800">
                                ...
                                <div className="flex-1 h-0 pt-5 pb-4 overflow-y-auto">
                                    ...
                                    <nav className="mt-5 px-2 space-y-1">
                                        {navigation.map((item) => (
                                            <Link onFinish={()=>setSidebarOpen(false)} key={item.name} href={item.href} className={classNames(
                                                component.startsWith(item.keyName)
                                                ...
                                                <item.icon
                                                    className={classNames(
                                                        component.startsWith(item.keyName) ? 'text-gray-300' : 'text-gray-400 group-hover:text-gray-300',
