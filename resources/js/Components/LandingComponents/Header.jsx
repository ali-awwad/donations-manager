          ...
          <Transition.Root>
            ...
            >
              ...
              >
                ...
                <li>
                  <Link href="#secondary-features" className="block w-full" onClick={() => close()}>
                      How it Works
                  </Link>
                </li>
                {/* <li>
        ...
        <nav className="relative z-50 text-sm">
          <ul className="flex items-center">
            ...
            <li className="ml-6 hidden md:block">
              <Link href="#secondary-features" className="rounded-lg py-1 px-2 text-slate-700 hover:bg-slate-100 hover:text-slate-900">
                  How it Works
              </Link>
            </li>
            {/* <li className="ml-6 hidden md:block">
