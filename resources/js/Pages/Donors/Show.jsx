        ...
        <>
            <div className="bg-white shadow overflow-hidden sm:rounded-lg">
                <div className="px-4 py-5 sm:px-6">
                    ...
                    <p className="mt-1 max-w-2xl text-sm text-gray-500">Details for <strong>{donor.name}</strong>.</p>
                </div>
                <div className="border-t border-gray-200 px-4 py-5 sm:px-6">
                    <dl className="grid grid-cols-1 gap-x-4 gap-y-8 sm:grid-cols-2">
                        ...
                        <div className="sm:col-span-1">
                            ...
                            <dd className="mt-1 text-sm text-gray-900">{donor.alias}</dd>
                        </div>
                        <div className="sm:col-span-1">
                            <dt className="text-sm font-medium text-gray-500">Linked with user</dt>
                            <dd className="mt-1 text-sm text-gray-900">{donor.user}</dd>
                        </div>
                        <div className="sm:col-span-1">
                            <dt className="text-sm font-medium text-gray-500">Total Donations</dt>
                            <dd className="mt-1 text-sm text-gray-900">AED {donor.total_donations}</dd>
                        </div>
                        <div className="sm:col-span-1">
                            <dt className="text-sm font-medium text-gray-500"># of donations</dt>
                            <dd className="mt-1 text-sm text-gray-900">{donor.donations_count}</dd>
                        </div>
                        <div className="sm:col-span-1">
                            <dt className="text-sm font-medium text-gray-500"># of campaigns participated in</dt>
                            <dd className="mt-1 text-sm text-gray-900">{donor.campaigns_count}</dd>
                        </div>
                        <div className="sm:col-span-1">
                            <dt className="text-sm font-medium text-gray-500"># of categories participated in</dt>
                            <dd className="mt-1 text-sm text-gray-900">{donor.categories_count}</dd>
                        </div>
            ...
            <DonationsTable items={donor.items} />
        </>
    )
}
