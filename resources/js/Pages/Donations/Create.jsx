...
export default function Create() {
    const { donors, campaigns, selected_campaign_id } = usePage().props
    ...
    function handleSubmit(e) {
        e.preventDefault()
        post(route('donations.store'), data)
    }
    ...
    return (
        <form onSubmit={handleSubmit} className="space-y-8 divide-y divide-gray-200">
            <div>
                <div>
                    <h3 className="text-lg leading-6 font-medium text-gray-900">Add new Donation {isDirty && <span className="sup text-red-500">*</span>}</h3>
