...
export default function SelectCampaignTable({ campaigns, setSelectedCampaign }) {
  return (
                    ...
                    {campaigns.data.map((item, index) => (
                        <tr key={index}>
                            ...
                            <td className="py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-6">
                                <button type='button' onClick={() => setSelectedCampaign(item.id)} className="btn btn-default">
